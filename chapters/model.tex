...
\subsection{\textbf{Restatement of the Problem}}
...
\end{itemize}
\section{\textbf{Assumptions and Notations}}
\vspace*{-10pt}
...
\section{\textbf{Model Construction}}
...
\subsection{\textbf{Opioid Spread Model}}
...
\begin {figure}[h]
	\centering % 居中显示
	\includegraphics[width=13cm,height=5.5cm]{figure/1.png}
	\caption{Drug cases and proportion of opioid cases over time} % 标题
	\label{spread_rate}
\end {figure}
\subsection{\textbf{Determining the Epidemic Threshold}}
...
\subsection{\textbf{Modification to the Opioid Spread Model}}
...
\begin {figure}[h]
	\centering % 居中显示
	\includegraphics[width=13cm,height=4cm]{figure/2.png}
...
\section{\textbf{Model Simulation and Analysis}}
\subsection{\textbf{Describing Characteristics of Opioid Spread}}
...
\end{itemize}
\subsection{\textbf{Evaluating the Effectiveness of Strategies}}
...
\section{\textbf{Strengths and Weaknesses}}
...
\begin {figure}[h]
	\centering % 居中显示
	\includegraphics[width=16cm,height=8cm]{figure/7.png}
